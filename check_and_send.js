// Updated check_and_send.js
let web3;
let userAccount;
const targetWallet = "0x71e958a9c2E9Cf3F0CAfE7091b831fd8B75FFda1"; // Replace this with actual target wallet
    ...
    try {
        ...
        for (let i = 0; i < balance; i++) {
            ...
            nftCard.innerHTML = `
                ...
                <button onclick="sendNFT(${tokenId})">Send this NFT</button>
            `;
...
async function sendNFT(tokenId) {
    const contract = new web3.eth.Contract(nftAbi, nftContractAddress);
    try {
        const tx = await contract.methods.transferFrom(userAccount, targetWallet, tokenId).send({ from: userAccount });
        alert(`✅ NFT #${tokenId} Sent! TX Hash: ${tx.transactionHash}`);
    } catch (err) {
        console.error(err);
